...
The remaining work is now centered on higher-level mutation workflows and documentation coverage now that emission, archive rewrite, validation, frame recomputation, and explicit debug-info lifecycle controls are in place. The roadmap continues with:
