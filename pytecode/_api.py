"""Thin public wrappers over the Rust binding surface."""

from __future__ import annotations

from . import _rust

Diagnostic = _rust.RustDiagnostic
MappingClassResolver = _rust.RustMappingClassResolver
RustClassModel = _rust.RustClassModel
...
def verify_classmodel(
    ...
    *,
    ...
    if not isinstance(value, RustClassModel):
        raise TypeError("verify_classmodel expects a RustClassModel")
