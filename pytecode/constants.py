...
class TargetInfoType(Enum):
    TYPE_PARAMETER = (TargetType.TYPE_PARAMETER_GENERIC_CLASS_OR_INTERFACE, TargetType.TYPE_PARAMETER_GENERIC_METHOD_OR_CONSTRUCTOR)
    SUPERTYPE = (TargetType.SUPERTYPE,)
    TYPE_PARAMETER_BOUND = (TargetType.TYPE_PARAMETER_BOUND_GENERIC_CLASS_OR_INTERFACE, TargetType.TYPE_PARAMETER_BOUND_GENERIC_METHOD_OR_CONSTRUCTOR)
    EMPTY = (TargetType.TYPE_IN_FIELD_OR_RECORD, TargetType.RETURN_OR_OBJECT_TYPE, TargetType.RECEIVER_TYPE_METHOD_OR_CONSTRUCTOR)
